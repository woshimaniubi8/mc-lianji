...
!(function (e) {
  ...
  if ('undefined' != typeof e) {
    ...
    ;(t.prototype = t.fn =
      {
        ...
        init: function (i, o) {
          ...
          ;(n.pluginPath = '' === n.pluginPath ? n.path + '../plugins/' : n.pluginPath),
            ...
            a.css({ width: 'number' == typeof n.width ? n.width + 'px' : n.width, height: 'number' == typeof n.height ? n.height + 'px' : n.height }),
          ...
          var c = [
            n.readOnly ? '' : '<a href="javascript:;" class="fa fa-close ' + r + 'preview-close-btn"></a>',
            n.saveHTMLToTextarea ? '<textarea class="' + s.textarea.html + '" name="' + i + '-html-code"></textarea>' : '',
            '<div class="' + r + 'preview"><div class="markdown-body ' + r + 'preview-container"></div></div>',
          ...
          return (
            ...
            'function' == typeof define &&
              ...
              n.searchReplace && !n.readOnly && (t.loadCSS(n.path + 'codemirror/addon/dialog/dialog'), t.loadCSS(n.path + 'codemirror/addon/search/matchesonscrollbar'))),
            ('function' == typeof define && define.amd) || !n.autoLoadModules
              ? ('undefined' != typeof CodeMirror && (t.$CodeMirror = CodeMirror), 'undefined' != typeof marked && (t.$marked = marked), this.setCodeMirror().setToolbar().loadedDisplay())
              : this.loadQueues(),
            this
          )
        },
        ...
        setCodeMirror: function () {
          ...
          return (
            (this.codeEditor = this.cm = t.$CodeMirror.fromTextArea(this.markdownTextarea[0], o)),
            (this.codeMirror = this.cmElement = i.children('.CodeMirror')),
            '' !== e.value && this.cm.setValue(e.value),
            this.codeMirror.css({ fontSize: e.fontSize, width: e.watch ? '50%' : '100%' }),
        ...
        extend: function () {
          return (
            'undefined' != typeof arguments[1] && ('function' == typeof arguments[1] && (arguments[1] = e.proxy(arguments[1], this)), (this[arguments[0]] = arguments[1])),
        ...
        showToolbar: function (t) {
          ...
          return i.readOnly
            ? this
            : (i.toolbar && (this.toolbar.length < 1 || '' === this.toolbar.find('.' + this.classPrefix + 'menu').html()) && this.setToolbar(),
              (i.toolbar = !0),
              this.toolbar.show(),
              this.resize(),
            ...
            return n.toolbarAutoFixed
              ? void r.css(
                  i - o.offset().top > 10 && i < o.height()
                    ? { position: 'fixed', width: o.width() + 'px', left: (t.width() - o.width()) / 2 + 'px' }
        ...
        setToolbar: function () {
          ...
          r.show()
          for (
            var a = 'function' == typeof e.toolbarIcons ? e.toolbarIcons() : 'string' == typeof e.toolbarIcons ? t.toolbarModes[e.toolbarIcons] : e.toolbarIcons,
            ...
            if ('||' === u) c = !0
              ...
              'undefined' != typeof e.toolbarCustomIcons[u] && 'function' != typeof e.toolbarCustomIcons[u]
                ...
                : ((v += '<a href="javascript:;" title="' + p + '" unselectable="on">'),
        ...
        createInfoDialog: function () {
          var e = this,
            ...
            r = [
              ...
              '<h1><i class="editormd-logo editormd-logo-lg editormd-logo-color"></i> ' + t.title + '<small>v' + t.version + '</small></h1>',
              '<p>' + this.lang.description + '</p>',
              '<p style="margin: 10px 0 20px 0;"><a href="' + t.homePage + '" target="_blank">' + t.homePage + ' <i class="fa fa-external-link"></i></a></p>',
              '<p style="font-size: 0.85em;">Copyright &copy; 2015 <a href="https://github.com/pandao" target="_blank" class="hover-link">Pandao</a>, The <a href="https://github.com/pandao/editor.md/blob/master/LICENSE" target="_blank" class="hover-link">MIT</a> License.</p>',
              '</div>',
              '<a href="javascript:;" class="fa fa-close ' + o + 'dialog-close"></a>',
              '</div>',
            ].join('\n')
          i.append(r)
          var n = (this.infoDialog = i.children('.' + o + 'dialog-info'))
          return (
            n.find('.' + o + 'dialog-close').bind(t.mouseOrTouch('click', 'touchend'), function () {
              e.hideInfoDialog()
            }),
            n
        ...
        showInfoDialog: function () {
          ...
          return (
            ...
            this.lockScreen(!0),
            this.mask.css({ opacity: o.dialogMaskOpacity, backgroundColor: o.dialogMaskBgColor }).show(),
        ...
        katexRender: function () {
          return null === i
            ? this
            : (this.previewContainer.find('.' + t.classNames.tex).each(function () {
                var i = e(this)
        ...
        bindScrollEvent: function () {
          ...
          return (
            n.bind({ mouseover: s, mouseout: l, touchstart: s, touchend: l }), 'single' === r.syncScrolling ? this : (o.bind({ mouseover: c, mouseout: h, touchstart: c, touchend: h }), this)
          )
        },
          ...
          if (
            ...
            !s.autoHeight || o.fullscreen || o.preview
              ? (i && r.css('height', 'number' == typeof i ? i + 'px' : i),
                ...
                s.toolbar && !s.readOnly ? l.css('margin-top', a.height() + 1).height(r.height() - a.height()) : l.css('margin-top', 0).height(r.height()))
        ...
        previewing: function () {
          ...
          'none' === s.css('display')
            ? ((this.state.preview = !0),
              ...
              r.show().css({ position: '', top: 0, width: o.width(), height: a.autoHeight && !this.state.fullscreen ? 'auto' : o.height() }),
          ...
          return (
            o.hasClass(a)
              ...
              : ((i.fullscreen = !0),
                ...
                o.css({ width: e(window).width(), height: e(window).height() }).addClass(a),
                this.resize(),
        ...
        fullscreenExit: function () {
          ...
          return (
            ...
            t.css({ width: t.data('oldWidth'), height: t.data('oldHeight') }).removeClass(r),
            this.resize(),
          ...
          return (
            ...
            'function' == typeof define
              ? 'undefined' == typeof this[i]
                ? (alert('Error: ' + i + ' plugin is not found, you are not load this plugin.'), this)
                : (this[i](n), this)
    ...
    return (
      ...
      (t.emoji = { path: 'http://www.emoji-cheat-sheet.com/graphics/emojis/', ext: '.png' }),
        ...
        return (
          ...
          (l.link = function (e, t, i) {
            ...
            return h.test(t) || h.test(i)
              ? (t && (n += ' title="' + t.replace(/@/g, '&#64;')), n + '">' + i.replace(/@/g, '&#64;') + '</a>')
              : (t && (n += ' title="' + t + '"'), (n += '>' + i + '</a>'))
          }),
          ...
          (l.listitem = function (e) {
            return a.taskList && /^\s*\[[x\s]\]\s*/.test(e)
              ? ((e = e
                  .replace(/^\s*\[\s\]\s*/, '<input type="checkbox" class="task-list-item-checkbox" /> ')
                  .replace(/^\s*\[x\]\s*/, '<input type="checkbox" class="task-list-item-checkbox" checked disabled /> ')),
                '<li style="list-style: none;">' + this.atLink(this.emoji(e)) + '</li>')
      ...
      (t.markdownToCRenderer = function (e, t, i, o) {
        ...
        for (var s = 0, l = e.length; l > s; s++) {
          var c = e[s].text,
            h = e[s].level
          o > h ||
            ((r += h > n ? '' : n > h ? new Array(n - h + 2).join('</ul></li>') : '</ul></li>'),
      ...
      (t.markdownToHTML = function (i, o) {
        ...
        if (
          ...
          a.toc &&
            ((n.tocContainer = this.markdownToCRenderer(c, f, a.tocDropdown, a.tocStartLevel)),
          ...
          a.previewCodeHighlight && (n.find('pre').addClass('prettyprint linenums'), prettyPrint()),
          t.isIE8 || (a.flowChart && n.find('.flowchart').flowChart(), a.sequenceDiagram && n.find('.sequence-diagram').sequenceDiagram({ theme: 'simple' })),
          a.tex)
        ) {
          var g = function () {
      ...
      (t.katexURL = { css: '//cdnjs.cloudflare.com/ajax/libs/KaTeX/0.3.0/katex.min', js: '//cdnjs.cloudflare.com/ajax/libs/KaTeX/0.3.0/katex.min' }),
      (t.kaTeXLoaded = !1),
      ...
      (t.createDialog = function (i) {
        ...
        '' !== i.title &&
          ((h += '<div class="' + a + 'dialog-header"' + (i.drag ? ' style="cursor: move;"' : '') + '>'),
            ...
            y = function (t) {
              ...
              r >= 0
                ? r + d.width() <= e(window).width()
                  ? (i = t.clientX - w)
                  : ((i = e(window).width() - d.width()), (document.onmousemove = null))
                : ((i = 0), (document.onmousemove = null)),
                n >= 0 ? (o = t.clientY - v) : ((o = 0), (document.onmousemove = null)),
            ...
            (k.touchDraggable = function () {
              var t = null,
                ...
                o = function (i) {
                  ...
                  e(this)
                    .parent()
                    .css({ top: o.changedTouches[0].pageY - t.y, left: o.changedTouches[0].pageX - t.x })
                }
